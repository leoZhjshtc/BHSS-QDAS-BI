...
public class QualityMonitorServiceImpl implements IQualityMonitorService{
	...
	public List getProductLineAlarmData(QualityMonitorBean qmb,List<Map> plList) {
		...
		if(plList.size()!=0) {
        	...
        	list=qmm.getProductLineAlarmData(qmb);
        	for(int i=0;i<list.size();i++) {
        		Map plMap= list.get(i);
    			plMap.put("qualityLevel", "0");
    			plMap.put("buttonId", list.get(i).get("TEKOSTST").toString().replaceAll(" ", "-"));
    			for(int j=0;j<plList.size();j++) {
    				if(list.get(i).get("TEKOSTST").toString().toUpperCase().equals(plList.get(j).get("productLine_name").toString().toUpperCase())) {
    					plMap.put("productLine_leftPosition", plList.get(j).get("productLine_leftPosition"));
    					plMap.put("point_topPosition", plList.get(j).get("point_topPosition"));
    					plMap.put("productLine_topPosition", plList.get(j).get("productLine_topPosition"));
    					plMap.put("point_leftPosition", plList.get(j).get("point_leftPosition"));
    				}
    			}
    			List<Map> wvList=(List<Map>) plMap.get("MEASURELIST");
    			for(int j=0;j<wvList.size();j++) {
    				if("1".equals(wvList.get(j).get("MEMERKART").toString())) {
    					if(Float.parseFloat(wvList.get(j).get("WVWERT").toString().substring(wvList.get(j).get("WVWERT").toString().indexOf(".")-1))>0) {
							plMap.put("qualityLevel", "2");
							plMap.put("alarmTeil", wvList.get(j).get("TETEILNR"));
							plMap.put("alarmMerkmal", wvList.get(j).get("MEMERKBEZ"));
							plMap.put("alarmTime", wvList.get(j).get("WVDATZEIT"));
							plMap.put("alarmResult", "不合格");
							break;
						}
    				}else {
						if(wvList.get(j).get("MEUGW")!=null&&wvList.get(j).get("WVWERT")!=null&&Float.parseFloat(String.valueOf(wvList.get(j).get("WVWERT")))<Float.parseFloat(String.valueOf(wvList.get(j).get("MEUGW")))) {
							plMap.put("qualityLevel", "2");
							plMap.put("alarmTeil", wvList.get(j).get("TETEILNR"));
							plMap.put("alarmMerkmal", wvList.get(j).get("MEMERKBEZ"));
							plMap.put("alarmTime", wvList.get(j).get("WVDATZEIT"));
							...
							break;
						}else if(wvList.get(j).get("MEOGW")!=null&&wvList.get(j).get("WVWERT")!=null&&Float.parseFloat(String.valueOf(wvList.get(j).get("WVWERT")))>Float.parseFloat(String.valueOf(wvList.get(j).get("MEOGW")))) {
							plMap.put("qualityLevel", "2");
							plMap.put("alarmTeil", wvList.get(j).get("TETEILNR"));
							plMap.put("alarmMerkmal", wvList.get(j).get("MEMERKBEZ"));
							plMap.put("alarmTime", wvList.get(j).get("WVDATZEIT"));
							...
							break;
						}else if(wvList.get(j).get("MENORMISTUN")!=null&&wvList.get(j).get("WVWERT")!=null&&Float.parseFloat(String.valueOf(wvList.get(j).get("WVWERT")))<Float.parseFloat(String.valueOf(wvList.get(j).get("MENORMISTUN")))) {
						...
						}else if(wvList.get(j).get("MENORMISTOB")!=null&&wvList.get(j).get("WVWERT")!=null&&Float.parseFloat(String.valueOf(wvList.get(j).get("WVWERT")))>Float.parseFloat(String.valueOf(wvList.get(j).get("MENORMISTOB")))) {
							if("0".equals(plMap.get("qualityLevel").toString())) {
								plMap.put("qualityLevel", "1");
    							plMap.put("alarmTeil", wvList.get(j).get("TETEILNR"));
    							plMap.put("alarmMerkmal", wvList.get(j).get("MEMERKBEZ"));
