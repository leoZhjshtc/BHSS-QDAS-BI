    					...
    					for(var i=0;i<data.length;i++){
    						...
    						for(var j=0;j<data[i].COUNTLIST.length;j++){
    							...
    							for(var k=0;k<data[i].COUNTLIST[j].WVCOUNTLIST.length;k++){
    								...
    								if(data[i].COUNTLIST[j].WVCOUNTLIST[k].MEMERKART!='1'&data[i].COUNTLIST[j].WVCOUNTLIST[k].CPKALARM=='1'){
    									warnCPKCount +=1;
    								}else if(data[i].COUNTLIST[j].WVCOUNTLIST[k].MEMERKART!='1'&data[i].COUNTLIST[j].WVCOUNTLIST[k].CPKALARM=='2'){
    									failCPKCount +=1;
    								}
    							}
    						}
    						...
    						if(warnCPKCount===0&failCPKCount===0){
    							...
    							cpkSuccessValue=100-cpkWarnValue-cpkFailValue;
    						}
