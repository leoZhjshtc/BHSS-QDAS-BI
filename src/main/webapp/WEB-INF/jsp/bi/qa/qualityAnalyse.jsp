...
<html>
  ...
  <body>
  	...
  	<div class="easyui-layout" fit="true">
  		<!-- <div data-options="region:'west',title:'参数比较',collapsed:true" style="overflow: hidden;width: 50%">
  			<div class="easyui-layout" fit="true" style="width: 100%;height: 100%">
		  		<div data-options="region:'center',border:false" style="overflow: hidden;">
		  			<div id="qaTeilPanel" class="easyui-panel" title="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;零件" data-options="fit:true,border:false" style="overflow:hidden;">
			  		</div>
			  		<div id="qaChartPanel" class="easyui-panel" title="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;图表" data-options="fit:true,closed:true,border:false,tools:[
																									{
																										iconCls:'icon-back',
																										handler:function(){
																											$('#qaChartPanel').panel('close');
																											$('#qaTeilPanel').panel('open');
																										}}]" style="overflow:hidden;">
			  				
			  		</div>
			  		<div id="qaDetailsPanel" class="easyui-panel" title="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;测量数据" data-options="fit:true,closed:true,border:false,tools:[
																									{
																										iconCls:'icon-back',
																										handler:function(){
																											$('#qaDetailsPanel').panel('close');
																											$('#qaTeilPanel').panel('open');
																										}}]" style="overflow:hidden;">
