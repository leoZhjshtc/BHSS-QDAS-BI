			...
			grid: {
			 ...
			 tooltip: {
	            ...
	            formatter:function(params){
	            	var res='<div><p>测量值：'+params[0].data+'</p><p>时间：'+tooltipTime[params[0].dataIndex]+'</p><p>测量人员：'+tooltipPRVORNAME[params[0].dataIndex]+'</p><p>测量设备：'+tooltipPMBEZ[params[0].dataIndex]+'</p><p>措施：'+tooltipMeasure[params[0].dataIndex]+'</p></div>';
	            	return res;
	            }
	        },
		    xAxis: {
